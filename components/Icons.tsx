...
export const InsightsIcon = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M9 9h6v6H9zM12 4v5M12 15v5M4 12h5M15 12h5" />
    </svg>
);
...
export const VersionControlIcon = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M5 7v4a2 2 0 002 2h10a2 2 0 002-2V7" />
    </svg>
);

// This icon is no longer used in the main app flow, but kept for potential use.
